...
`brain_tumor_federated_learning.py` is a Python implementation developed by **Er. Panchanan Nath** for simulating **Federated Learning (FL)** on a **Dataset consisting of MRI image of human brain tumor**.  
